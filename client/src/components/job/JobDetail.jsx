...
function JobDetail({ jobDetail }) {
    ...
    return (
        <div className="m-7">
                ...
                <div className="flex justify-around ">
                    <div className="">
                        ...
                        <div className="flex gap-2 items-center">
                            ...
                            Lĩnh vực ứng tuyển:<span className="ml-auto">{jobDetail?.field}</span>
                        </div>
                    ...
                    <div className="">
                        ...
                        <div className="flex gap-2 items-center">
                            ...
                            Vị trí làm việc:<span className="ml-auto">{jobDetail?.position}</span>
                        </div>
                    </div>
                    <div >
                        <div className="flex mb-7 gap-2 items-center">
            ...
            <h2 className="mx-14 mt-16 mb-7 text-2xl text-gray-900 font-extralight">MÔ TẢ CÔNG VIỆC:</h2>
            <div className="mx-14 tracking-wide ">
